...
GO
PRINT N'Création de [dbo].[Option]...';
...
GO
PRINT N'Création de contrainte sans nom sur [dbo].[Option]...';


GO
ALTER TABLE [dbo].[Option]
    ADD DEFAULT 0 FOR [EstDisponible];
...
END
GO
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = 'fdf52d0f-fe38-469b-9310-65f9db6124f7')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('fdf52d0f-fe38-469b-9310-65f9db6124f7')
