...
namespace HomeShare.Entities
{
    ...
    {
        int _idBien, _nombrePerson, _pays, _idMembre;
        string _titre, _descCourte, _descLong, _ville, _rue, _numero, _codePostal, _photo, _latitude, _longitude;
        bool _assuranceObligatoire, _isEnabled;
